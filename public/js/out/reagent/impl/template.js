...
var G__22779 = o;
(G__22779[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22788 = jsprops;
(G__22788["defaultValue"] = value);

(G__22788["onChange"] = ((function (G__22788,v,value,on_change){
return (function (p1__22785_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22785_SHARP_);
});})(G__22788,v,value,on_change))
);

(G__22788["ref"] = ((function (G__22788,v,value,on_change){
return (function (p1__22786_SHARP_){
return (this$["cljsInputElement"] = p1__22786_SHARP_);
});})(G__22788,v,value,on_change))
);
...
var vec__22795 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22795,(0),null);
var id = cljs.core.nth.call(null,vec__22795,(1),null);
var class$ = cljs.core.nth.call(null,vec__22795,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___22800 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___22800 == null)){
} else {
var key_22801 = temp__4661__auto___22800;
(jsprops["key"] = key_22801);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__22803 = (new reagent.impl.template.NativeWrapper());
(G__22803["name"] = c);
...
var len__21234__auto___22809 = arguments.length;
var i__21235__auto___22810 = (0);
while(true){
if((i__21235__auto___22810 < len__21234__auto___22809)){
args__21241__auto__.push((arguments[i__21235__auto___22810]));

var G__22811 = (i__21235__auto___22810 + (1));
i__21235__auto___22810 = G__22811;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22807){
var G__22808 = cljs.core.first.call(null,seq22807);
var seq22807__$1 = cljs.core.next.call(null,seq22807);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__22808,seq22807__$1);
});
...
break;
default:
var G__22815 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22815;
continue;
...
var n__21074__auto___22818 = a.length;
var i_22819 = (0);
while(true){
if((i_22819 < n__21074__auto___22818)){
(a[i_22819] = reagent.impl.template.as_element.call(null,(a[i_22819])));

var G__22820 = (i_22819 + (1));
i_22819 = G__22820;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21074__auto___22821 = a.length;
var i_22822 = (0);
while(true){
if((i_22822 < n__21074__auto___22821)){
var val_22823 = (a[i_22822]);
if((cljs.core.vector_QMARK_.call(null,val_22823)) && ((reagent.impl.template.key_from_vec.call(null,val_22823) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22822] = reagent.impl.template.as_element.call(null,val_22823));
...
var ctx = ({});
var vec__22828 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22828,(0),null);
var derefed = cljs.core.nth.call(null,vec__22828,(1),null);
...
var G__22832 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22832) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22832){
